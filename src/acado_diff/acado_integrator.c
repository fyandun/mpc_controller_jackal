...
{ 8.3333333333333332e-03, -1.6666666666666666e-03, 
1.4999999999999999e-02, 5.0000000000000001e-03 };
...
acado_diffs( acadoWorkspace.rk_xxx, &(acadoWorkspace.rk_diffsTemp2[ run1 * 35 ]) );
for (j = 0; j < 5; ++j)
{
tmp_index1 = (run1 * 5) + (j);
acadoWorkspace.rk_A[tmp_index1 * 10] = + acado_Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 35) + (j * 7)];
acadoWorkspace.rk_A[tmp_index1 * 10 + 1] = + acado_Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 35) + (j * 7 + 1)];
acadoWorkspace.rk_A[tmp_index1 * 10 + 2] = + acado_Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 35) + (j * 7 + 2)];
acadoWorkspace.rk_A[tmp_index1 * 10 + 3] = + acado_Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 35) + (j * 7 + 3)];
acadoWorkspace.rk_A[tmp_index1 * 10 + 4] = + acado_Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 35) + (j * 7 + 4)];
if( 0 == run1 ) acadoWorkspace.rk_A[(tmp_index1 * 10) + (j)] -= 1.0000000000000000e+00;
acadoWorkspace.rk_A[tmp_index1 * 10 + 5] = + acado_Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 35) + (j * 7)];
acadoWorkspace.rk_A[tmp_index1 * 10 + 6] = + acado_Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 35) + (j * 7 + 1)];
acadoWorkspace.rk_A[tmp_index1 * 10 + 7] = + acado_Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 35) + (j * 7 + 2)];
acadoWorkspace.rk_A[tmp_index1 * 10 + 8] = + acado_Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 35) + (j * 7 + 3)];
acadoWorkspace.rk_A[tmp_index1 * 10 + 9] = + acado_Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 35) + (j * 7 + 4)];
...
for (i = 0; i < 2; ++i)
{
acadoWorkspace.rk_b[i * 5] = - acadoWorkspace.rk_diffsTemp2[(i * 35) + (run1)];
acadoWorkspace.rk_b[i * 5 + 1] = - acadoWorkspace.rk_diffsTemp2[(i * 35) + (run1 + 7)];
acadoWorkspace.rk_b[i * 5 + 2] = - acadoWorkspace.rk_diffsTemp2[(i * 35) + (run1 + 14)];
acadoWorkspace.rk_b[i * 5 + 3] = - acadoWorkspace.rk_diffsTemp2[(i * 35) + (run1 + 21)];
acadoWorkspace.rk_b[i * 5 + 4] = - acadoWorkspace.rk_diffsTemp2[(i * 35) + (run1 + 28)];
}
if( 0 == run1 ) {
det = acado_solve_dim10_system( acadoWorkspace.rk_A, acadoWorkspace.rk_b, acadoWorkspace.rk_dim10_perm );
}
...
acadoWorkspace.rk_diffsNew2[(i * 7) + (run1)] += + acadoWorkspace.rk_diffK[i * 2]*(real_t)1.4999999999999999e-02 + acadoWorkspace.rk_diffK[i * 2 + 1]*(real_t)5.0000000000000001e-03;
}
}
for (run1 = 0; run1 < 2; ++run1)
{
...
tmp_index1 = (i * 5) + (j);
tmp_index2 = (run1) + (j * 7);
acadoWorkspace.rk_b[tmp_index1] = - acadoWorkspace.rk_diffsTemp2[(i * 35) + (tmp_index2 + 5)];
}
}
acado_solve_dim10_system_reuse( acadoWorkspace.rk_A, acadoWorkspace.rk_b, acadoWorkspace.rk_dim10_perm );
for (i = 0; i < 2; ++i)
...
for (i = 0; i < 5; ++i)
{
acadoWorkspace.rk_diffsNew2[(i * 7) + (run1 + 5)] = + acadoWorkspace.rk_diffK[i * 2]*(real_t)1.4999999999999999e-02 + acadoWorkspace.rk_diffK[i * 2 + 1]*(real_t)5.0000000000000001e-03;
}
}
rk_eta[0] += + acadoWorkspace.rk_kkk[0]*(real_t)1.4999999999999999e-02 + acadoWorkspace.rk_kkk[1]*(real_t)5.0000000000000001e-03;
rk_eta[1] += + acadoWorkspace.rk_kkk[2]*(real_t)1.4999999999999999e-02 + acadoWorkspace.rk_kkk[3]*(real_t)5.0000000000000001e-03;
rk_eta[2] += + acadoWorkspace.rk_kkk[4]*(real_t)1.4999999999999999e-02 + acadoWorkspace.rk_kkk[5]*(real_t)5.0000000000000001e-03;
rk_eta[3] += + acadoWorkspace.rk_kkk[6]*(real_t)1.4999999999999999e-02 + acadoWorkspace.rk_kkk[7]*(real_t)5.0000000000000001e-03;
rk_eta[4] += + acadoWorkspace.rk_kkk[8]*(real_t)1.4999999999999999e-02 + acadoWorkspace.rk_kkk[9]*(real_t)5.0000000000000001e-03;
if( run == 0 ) {
for (i = 0; i < 5; ++i)
{
for (j = 0; j < 5; ++j)
